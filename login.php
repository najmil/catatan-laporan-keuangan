  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-5 col-lg-7 col-md-9">
        ...
        <div class="card o-hidden shadow-lg border-0 my-5" xss="removed">
                <div class="p-5">
                  ...
                  <form class="user" action="proses-login.php" method="post">
                    ...
                    <input type="submit" name="submit" class="btn btn-warning btn-user btn-block" value="Masuk">
                  </form>
                  <hr>
                </div>
