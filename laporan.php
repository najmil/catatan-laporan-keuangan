            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
				          <?php
                  $pemasukan=mysqli_query($koneksi,"SELECT * FROM pemasukkan");
                  ...
                  $query1 = mysqli_query($koneksi,"SELECT id_masuk FROM pemasukkan");
                  ...
                  ?>
                    <tr>
                      ...
                      <td> <a href="export-pemasukan.php" type="button" 
                      class="btn btn-primary btn-md"><i class="fa fa-download"></i></a> </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td> <a href="export-pengeluaran.php" type="button" 
                      class="btn btn-primary btn-md"><i class="fa fa-download"></i></a> </td>
                    </tr>
